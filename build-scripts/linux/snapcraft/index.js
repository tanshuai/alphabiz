...
const buildArch = process.env.BUILD_ARCH || process.env.ARCH || process.arch
...
const prepareSnap = async () => {
  ...
  const buildDist = resolve(__rootdir, `dist/electron/${appConfig.displayName}-linux-${buildArch}`)
